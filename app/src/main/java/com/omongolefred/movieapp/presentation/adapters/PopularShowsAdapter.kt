...
class PopularShowsAdapter : Adapter<PopularShowsAdapter.ShowViewHolder>() {
    ...
    private val differCallBack = object : DiffUtil.ItemCallback<ShowPopular>() {
        override fun areItemsTheSame(oldItem : ShowPopular , newItem : ShowPopular ) : Boolean {
            return oldItem.id == newItem.id
        }
        override fun areContentsTheSame( oldItem : ShowPopular , newItem : ShowPopular ) : Boolean {
